...
from ocode_python.tools.memory_tools import MemoryWriteTool, MemoryReadTool
from ocode_python.core.engine import OCodeEngine
from ocode_python.core.api_client import OllamaAPIClient, CompletionRequest
...
class TestIntelligentMemorySystem(unittest.TestCase):
    ...
    async def test_llm_query_analysis(self):
        ...
        analysis = await self.engine._llm_should_use_tools("Remember my email is test@example.com")
        ...
        analysis = await self.engine._llm_should_use_tools("Analyze the entire codebase architecture")
