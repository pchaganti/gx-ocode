...
class TestSession:
    ...
    def test_session_add_message(self):
        ...
        session = Session(
            id="test-123", title="Test", model="test-model", conversation=[]
        )
...
class TestSessionManager:
    ...
    def test_create_session(self, temp_dir: Path):
        ...
        session = manager.create_session(title="Test Session", model="test-model")
...
class TestSessionMetadata:
    ...
    def test_metadata_to_dict(self):
        ...
        metadata = SessionMetadata(project_path="/test", custom_data={"key": "value"})
