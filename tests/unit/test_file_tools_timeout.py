...
class TestFileReadToolTimeout:
    ...
    @pytest.mark.asyncio
    async def test_file_read_adjusts_timeout_for_large_files(self, file_read_tool, tmp_path):
        ...
        with patch('ocode_python.tools.file_tools.async_timeout') as mock_timeout:
            ...
            result = await file_read_tool.execute(
                path=str(test_file),
                timeout=1.0  # Initial timeout of 1 second
            )
    ...
    async def test_file_read_timeout_error(self, file_read_tool, tmp_path):
        ...
        with patch('asyncio.get_event_loop') as mock_loop:
            ...
            with patch('ocode_python.tools.file_tools.async_timeout') as mock_timeout:
                ...
                mock_cm.__aexit__ = AsyncMock(side_effect=TimeoutError(
