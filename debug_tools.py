...
def main():
    ...
    try:
        ...
        categories = {
            "File Operations": ["fileread", "filewrite", "filelist", "glob", "advancedglob", "grep", "codegrep", "ls", "fileedit"],
        ...
        uncategorized = [tool.name for tool in tools if tool.name not in categorized_tools]
        if uncategorized:
            print("📋 Other Tools")
            print("-" * 11)
