...
class CopyTool(Tool):
    ...
    async def execute(self, source: str, destination: str, recursive: bool = False, preserve: bool = True, **kwargs) -> ToolResult:
        ...
        try:
            ...
            if src_path.is_file():
                ...
                return ToolResult(
                    ...
                    metadata={"source": source, "destination": str(dst_path), "type": "file"}
                )
                ...
                return ToolResult(
                    ...
                    metadata={"source": source, "destination": str(dst_path), "type": "directory"}
                )
...
class RemoveTool(Tool):
    ...
    async def execute(self, path: str, recursive: bool = False, force: bool = False, **kwargs) -> ToolResult:
