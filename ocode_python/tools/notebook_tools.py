    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        try:
            ...
            result = {
                ...
                "kernel": notebook_data.get("metadata", {}).get("kernelspec", {}).get("name", "unknown"),
                "language": notebook_data.get("metadata", {}).get("language_info", {}).get("name", "unknown"),
                "cells": []
            }
            ...
            if cell_range:
                selected_indices = self._parse_cell_range(cell_range, len(notebook_data.get("cells", [])))
