...
class ProcessMonitorTool(Tool):
    ...
    async def _action_list(self, sort_by: str, limit: int, output_format: str) -> ToolResult:
        ...
        processes.sort(key=sort_key.get(sort_by, sort_key['cpu']), reverse=sort_by in ['cpu', 'memory'])
