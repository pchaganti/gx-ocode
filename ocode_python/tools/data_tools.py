...
class JsonYamlTool(Tool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        try:
            ...
            if action == "parse":
                ...
                result = await self._action_set(data, path, value, detected_format, output_path, pretty)
    ...
    async def _action_parse(self, data: Any, format_type: str, pretty: bool) -> ToolResult:
    ...
    async def _action_query(self, data: Any, query: str) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                success=False,
                output="",
                error=f"Invalid JSONPath query: {e}"
            )

    async def _action_set(self, data: Any, path: str, value: str, format_type: str, 
                         output_path: Optional[str], pretty: bool) -> ToolResult:
