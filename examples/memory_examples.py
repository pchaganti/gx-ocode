...
async def example_advanced_memory_patterns():
    ...
    schema_versions = [
        ...
        {'version': '2.0', 'fields': ['id', 'name', 'email', 'created_at', 'updated_at', 'status']}
    ]
...
async def example_practical_workflows():
    ...
    async for chunk in engine.process("What did I work on today? Show me my session notes."):
        print(chunk, end='', flush=True)
    print()
...
async def main():
    ...
    try:
        ...
        print("   2. The function calling model: MFDoom/deepseek-coder-v2-tool-calling:latest")
